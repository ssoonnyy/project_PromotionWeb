document.addEventListener("DOMContentLoaded", () => {
  ...
  function con01Count() {
    const target = document.querySelector(".visual_main");
    let targetHeight = target.offsetHeight;
    if (
      document.body.scrollTop > targetHeight / 2 ||
      document.documentElement.scrollTop > targetHeight / 2
    ) {
      ...
      const driverCount01 = document.querySelector(
        ".num_box02 > .con01_count01"
      );
      ...
      const hybridsCount02 = document.querySelector(
        ".num_box03 .con01_count02"
      );
      ...
      const wedgesCount01 = document.querySelector(
        ".num_box06 > .con01_count01"
      );
